(function() {
  ...
  _.reject = function(collection, test) {
    ...
    let notPass = _.filter(collection, function(element) {
      return test(element) ? false : true
    })
    return notPass
  };
  ...
  _.uniq = function(array, isSorted, iterator) {
    ...
    if(isSorted) {
      ...
      _.each(array, function(element) {
        if(_.indexOf(returnArray, iterator(element)) === -1) {
          returnArray.push(iterator(element))
        }
      })
      return returnArray
  ...
  _.reduce = function(collection, iterator, accumulator) {
    ...
    _.each(collection.slice(sliceIndex), function(element) {
